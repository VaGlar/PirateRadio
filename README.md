...
- Μείξη με ήχο συστήματος (π.χ. Spotify) μέσω `getDisplayMedia` tab-audio
  ...
  έντασης μικροφώνου/μουσικής. Προαιρετικό auto-ducking: η μουσική
  χαμηλώνει αυτόματα όσο μιλάει κάποιο μικρόφωνο, χωρίς να χρειάζεται να
  κουνάς εσύ το crossfader κάθε φορά.
